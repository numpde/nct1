% Autogenerated by populate_scenarios.py on UTC-20211017-081050.

c = m.Compartments({m.Compartments.Name} == "NE");
assert(1 == length(c));
assert(c.Units == "picoliter");
c.Value = 1;

c = [m.Species.Parent];
s = m.Species(({m.Species.Name} == "CAS(c)") & ({c.Name} == "NE"));
assert(1 == length(s));
assert(s.Units == "uM");
s.Value = 1;

c = [m.Species.Parent];
s = m.Species(({m.Species.Name} == "CAS(n)") & ({c.Name} == "NE"));
assert(1 == length(s));
assert(s.Units == "uM");
s.Value = 0;

c = [m.Species.Parent];
s = m.Species(({m.Species.Name} == "ΔCAS(c)") & ({c.Name} == "NE"));
assert(1 == length(s));
assert(s.Units == "uM");
s.Value = 0;

c = [m.Species.Parent];
s = m.Species(({m.Species.Name} == "ΔCAS(n)") & ({c.Name} == "NE"));
assert(1 == length(s));
assert(s.Units == "uM");
s.Value = 0;

c = [m.Species.Parent];
s = m.Species(({m.Species.Name} == "Ran·GTP(n)") & ({c.Name} == "NE"));
assert(1 == length(s));
assert(s.Units == "uM");
s.Value = 3;

c = [m.Species.Parent];
s = m.Species(({m.Species.Name} == "NPC") & ({c.Name} == "NE"));
assert(1 == length(s));
assert(s.Units == "uM");
s.Value = 2;

c = [m.Species.Parent];
s = m.Species(({m.Species.Name} == "ImpB(c)") & ({c.Name} == "NE"));
assert(1 == length(s));
assert(s.Units == "uM");
s.Value = 0.05;

c = [m.Species.Parent];
s = m.Species(({m.Species.Name} == "ImpB(n)") & ({c.Name} == "NE"));
assert(1 == length(s));
assert(s.Units == "uM");
s.Value = 0;

c = [m.Species.Parent];
s = m.Species(({m.Species.Name} == "ImpA(c)") & ({c.Name} == "NE"));
assert(1 == length(s));
assert(s.Units == "uM");
s.Value = 0.5;

c = [m.Species.Parent];
s = m.Species(({m.Species.Name} == "ImpA(n)") & ({c.Name} == "NE"));
assert(1 == length(s));
assert(s.Units == "uM");
s.Value = 0.5;
