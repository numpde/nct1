...
\ce{A + B $\rightleftharpoons$ AB $\rightleftharpoons$ AB^*}.
%
%
...
\[
	...
	k_{d2} = \SI{7.4e-4}{s^{-1}},
\]
for \ce{Imp\beta} binding to the IBB domain (see \cite{Catimel2001}).
%
%
...
\caption{%
	...
	simulation of
	\eqref{e:AB*}
	starting with $\SI{3}{\micro M}$ \ce{Imp\beta}
	and $\SI{1}{\micro M}$ \ce{Cargo}
	with
...
is
\protect\input{../code/20210225-GSR/v2/python/b_graph1/report/free_cargo_ratio.tex}\unskip
-fold.
%
%
...
\caption{%
	...
	is
	\protect\input{../code/20210225-GSR/v2/python/b_graph1/report/nuc_to_cyto_cargo_ratio.tex}\unskip
	-fold.
	%
