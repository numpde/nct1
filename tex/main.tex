...
\[
	...
	\text{
		...
		{numpde.github.io/nct1/code/20211018-Appli/checkpoint/\checkpoint/}
	}
\]
...
but on the cytoplasmic side,
the hydrolysis reaction \eqref{e:hydrolysis}
disassembles it.
...
\cite[\href{https://i.ibb.co/0nLsTZv/Screenshot-from-2022-01-28-15-03-10.png}{Fig.~4a}]{NguyenPappireddiWuhr2019} -- probably from \cite{WuhrETAL2014}
...
\item
	Increase the number of NPC tenfold.
	\TODO{Why}
