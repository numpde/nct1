...
\title{Computational model of minimal NCT}
\author{R.~Andreev, L.~Kapinos, R.~Y.~H.~Lim}
...
\TODO{hydrolysis rate!?}

\TODO{what is NCT}


\TODO{who is involved -- transport receptors}
\TODO{why these transport recp}
\TODO{models}

\TODO{contsrut atrificial cells to reproduce a minimalistic NCT system, with the minimal reasonable number of players and to explain observations in vivo showing down or upregulation of certain species}
\TODO{the computatino al model, in turn, closely resembles the design of the artificial cell}
\TODO{here we want to prove that with those players of NCT, the essential observations from  are reproduced}

\TODO{role}
\TODO{sys with compartments}
\TODO{visual distribution assuming simple system}
...
%
\TODO{do they have a steady-state result}	
\TODO{kinetic behavior of Imp, in addition to cargo and ran}
\TODO{no NE}
\TODO{we look at steady-state}
%
...
\TODO{explain initial/final/steady-state}
...
%
This corresponds to all isoforms (\TODO{paralogs?}) of Kap$\upalpha$ (KPNA2,3,4,6)
\TODO{[unpublished]}.
%
%
However,
...
%
%
We settled on the \ce{Imp$\upalpha$} concentration of \SI{0.5}{\micro M}
for the baseline model,
which is close to isoform Kap$\upalpha$1 (KPNA2).
\TODO{link gene}
\TODO{rerun}
...
%
%
\TODO{:} To see the impact of the prameter on the transport
and its robustness,
possibly mimicking
different cell types and disesase

\TODO{:}
Decrease can be validated by depletion 
via siRNA
and
increase by transfection with a vector
...
\item 
	...
	Slighit accumulation in the nucleus
	
\item
	Increase the number of NPCs tenfold.
	
	Observe incrase of Impb contrast at the NE
	Kalita 2022
	
\item
	Increase \ce{Imp$\upalpha$} tenfold.
	
	Breakdown of transprt..

\item
	Decrease \ce{Imp$\upalpha$} tenfold.
	
	Trnasport still works..
...
\TODO{artificial cell should reproduce these}
...
\begin{figure}
	...
	\begin{minipage}{0.32\textwidth}
		\centering
		%
		\protect\TODO{HIGH NPC} High \ce{Imp$\upalpha$}
		\\
